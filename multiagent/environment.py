...
class MultiAgentEnv(gym.Env):
    ...
    def __init__(self, world, reset_callback=None, reward_callback=None,
        ...
        self.world = world
        self.agents = self.world.policy_agents # policy_agents is a property in world (see core.py) and instantiated by make_world in simple_tag.py
    ...
    def _step(self, action_n):
        ...
        for agent in self.agents:
            ...
            info_n['n'].append(self._get_info(agent)) # _get_info returns nothing
